...
export const Hero = () => {
  return (
    <Container>
      <section className="relative flex flex-col items-center justify-center py-16 sm:py-20 lg:py-24">
        <div className="relative max-w-3xl text-center px-6">
          ...
          {/* Heading */}
          <h1 className="mt-5 text-4xl font-bold text-gray-900 sm:text-5xl lg:text-6xl font-poppins leading-[1.2]">
