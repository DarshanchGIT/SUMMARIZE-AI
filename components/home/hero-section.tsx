...
export const Hero = () => {
  return (
    <section className="relative py-10 sm:py-14 lg:pt-18 xl:pb-0 font-sans">
      <div className="relative px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl pb-12">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <h1 className="mt-4 text-3xl font-bold leading-tight text-gray-900 sm:text-4xl sm:leading-tight lg:text-5xl lg:leading-tight font-pj">
            Get concise summaries of your PDFs instantly
          </h1>
          <p className="max-w-md mx-auto mt-5 text-sm leading-6 text-gray-600 font-inter">
